...
# 文件夹路径
data_folder = r"D:\work_GuoLin\machine_learning\machinelearning\src\guolin\CNN_single_ICC\data"
output_folder = r"D:\work_GuoLin\machine_learning\machinelearning\src\guolin\CNN_single_ICC\output_for_cnn"
...
for csv_file in os.listdir(data_folder):
    if csv_file.endswith(".csv"):
        ...
        assert data.shape == (1544, 511), "数据形状不符合预期"
