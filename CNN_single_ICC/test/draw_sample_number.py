...
# 加载标签数据
labels_path = 'D:\\work_GuoLin\\machine_learning\\machinelearning\\src\\guolin\\CNN_single_ICC\\output_for_cnn\\labels.npy'
...
plt.text(0.82, 0.12, '512', ha='center', va='center', fontsize=48, color='red', transform=fig.transFigure)
