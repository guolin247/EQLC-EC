...
# CSV 文件夹路径
folder_path = r"D:\work_GuoLin\machine_learning\machinelearning\src\guolin\CNN_single_ICC\test\result"
...
# 定义所需算法的固定顺序
desired_order = ['RandomForest', 'SVM', 'AdaBoost', 'XGBoost', 'EQLC', 'SoftVoting', 'HardVoting']
...
# 设置从第四个箱体位置绘制一条水平的虚线
median_value = np.median(ordered_prec_data[3])  # 计算第四个箱体的中位数
