...
# 标签文件路径
label_path = 'D:\\work_GuoLin\\machine_learning\\machinelearning\\src\\guolin\\CNN_CHD\\stratified_split_data\\y_2.npy'
...
# 为数据集设置颜色
colors = ['#EC3E3154', '#EC3E31']

# 为数据集设置标签
group_labels = ['Control', 'CHD']
