...
# 主程序部分
num_classes = 2
input_size = 2463  # 根据你的数据调整
dropout_value = 0.0  # 将 dropout 值作为参数传递
...
train_model(model, train_loader, test_loader, num_epochs=400, learning_rate=0.001, criterion=criterion, weight_decay=0.001, dropout_value=dropout_value)
