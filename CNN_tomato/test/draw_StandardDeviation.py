...
# 读取 Excel 文件
file_path = r'D:\work_GuoLin\machine_learning\machinelearning\src\guolin\CNN_TOMATO\test\Standard_Deviation.xlsx'
...
for i, metric in enumerate(metrics):
    ...
    ax.xaxis.set_major_locator(MultipleLocator((x_limits[metric][1] - x_limits[metric][0]) / 4))
