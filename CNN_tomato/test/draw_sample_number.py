...
# 加载标签数据
labels_path = 'D:\\work_GuoLin\\machine_learning\\machinelearning\\src\\guolin\\CNN_TOMATO\\output_for_cnn\\labels.npy'
...
# subset_counts = [int(count * 0.29) for count in counts_list]  # 假设测试集占20%
subset_counts = [240, 230]  # 假设测试集占20%
...
plt.text(0.83, 0.12, '16227', ha='center', va='center', fontsize=48, color='red', transform=fig.transFigure)
