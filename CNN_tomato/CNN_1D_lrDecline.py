...
train_model(model, train_loader, test_loader, num_epochs=50, learning_rate=0.00001, criterion=criterion, weight_decay=0.001, dropout_value=dropout_value)
