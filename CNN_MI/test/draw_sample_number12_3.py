...
# 设置绘图数据
colors = ['#0076B927', '#EC3E3127', '#6BBC47']  # 训练集使用不同的颜色
...
# # 手动设置图例的颜色和标签
handles = [
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='#0076B927', markersize=10, label='Training Set'),
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='#EC3E3127', markersize=10, label='Training Set'),
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='#6BBC47', markersize=10, label='Testing Set')
]
