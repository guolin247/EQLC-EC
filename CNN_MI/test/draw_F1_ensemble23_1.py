...
relative_folder_path = r"CNN_MI\test\result"
...
# 绘制箱线图并设置每个箱体的颜色
box = ax.boxplot(ordered_f1_data, tick_labels=ordered_algorithm_names, patch_artist=True)

for patch, color in zip(box['boxes'], box_colors):
    patch.set_facecolor(color)

# 设置从第三个箱体位置绘制一条平度的虚线
median_value = 0.876  # 手动设置中位数值
