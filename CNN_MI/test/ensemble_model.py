...
class Simple1DCNN(nn.Module):
    def __init__(self, input_size, num_classes, dropout_value=0.05):
        ...
        self.fc1 = nn.Linear(64 * 52, 128)  # Update to match the output size from conv+pool
...
# 加载所有模型
models_dir = r"D:\work_GuoLin\machine_learning\machinelearning\src\guolin\CNN_MI\models_for_ensemble"
...
# 保存文件路径
result_folder = r"D:\work_GuoLin\machine_learning\machinelearning\src\guolin\CNN_MI\test"
